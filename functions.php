...
function twentynineteen_scripts() {
	if(strstr($_SERVER['SERVER_NAME'], 'sqft-company.local')) {
		...
		wp_enqueue_script('uce-Scripts', get_theme_file_uri('/bundled-assets/scripts.59da8f18563b0f944e58.js') , NULL , '1.0', true);
		wp_enqueue_style('uce-Styles', get_theme_file_uri('/bundled-assets/styles.59da8f18563b0f944e58.css'));
