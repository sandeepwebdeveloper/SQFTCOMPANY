...
function twentynineteen_scripts() {
	if(strstr($_SERVER['SERVER_NAME'], 'sqft-company.local')) {
		...
		wp_enqueue_script('uce-Scripts', get_theme_file_uri('/bundled-assets/scripts.530be9de032294d506a9.js') , NULL , '1.0', true);
		wp_enqueue_style('uce-Styles', get_theme_file_uri('/bundled-assets/styles.530be9de032294d506a9.css'));
...
if( function_exists('acf_add_local_field_group') ):
    ...
    acf_add_local_field_group(array(
        ...
        'fields' => array(
            ...
            array(
                'key' => 'project_sub_title',
                'label' => 'Project Sub Title',
                'name' => 'project_sub_title',
                'type' => 'wysiwyg',
                'instructions' => 'Add Project Sub Title',
                'required' => 0,
                'conditional_logic' => 0,
                'wrapper' => array(
                    'width' => '',
            ...
            array(
                ...
                'name' => 'Building_Size',
                'type' => 'text',
                'instructions' => 'Add Building Size',
                'required' => 0,
                'conditional_logic' => 0,
                'wrapper' => array(
                    'width' => '',
            ...
            array(
                'key' => 'project_occupancy',
                'label' => 'Project Occupancy',
                'name' => 'project_occupancy',
                'type' => 'text',
                'instructions' => 'Add Project Occupancy',
                'required' => 0,
                'conditional_logic' => 0,
                'wrapper' => array(
                    'width' => '',
            ...
            array(
                'key' => 'project_available_unit',
                'label' => 'Project Avilable Unit',
                'name' => 'project_available_unit',
                'type' => 'text',
                'instructions' => 'Add Avilable Unit',
                'required' => 0,
                'conditional_logic' => 0,
                'wrapper' => array(
                    'width' => '',
