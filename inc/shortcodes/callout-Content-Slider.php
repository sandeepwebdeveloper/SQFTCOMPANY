...
// Element Class
class SliderContentCallout {
	// element Init
	function __construct() {
		add_action( 'init', array( $this, 'kc_Slider_Content_callout_mapping' ), 99 );
		add_shortcode( 'kc_Slider_Content_callout', array( $this, 'kc_Slider_Content_callout_html' ) );
	 ...
	 * Map element
	 */
	function kc_Slider_Content_callout_mapping() {

		if ( function_exists( 'kc_add_map' ) ) {
			kc_add_map(
				array(

					'kc_Slider_Content_callout' => array(
						'name'        => __( 'Slider Content Callout', 'msteele' ),
	 ...
	 * @return string
	 */
	function kc_Slider_Content_callout_html( $atts ) {
		// params extraction
		extract(
			shortcode_atts(
				array(
		...
		if ( $images ): ?>
            ...
            <div class="slider-callout swiper swiper-container full-slider <?php echo $atts['class']; ?>">
