...
class SliderCallout {
	...
	function __construct() {
		add_action( 'init', array( $this, 'kc_slider_callout_mapping' ), 99 );
		add_shortcode( 'kc_slider_callout', array( $this, 'kc_slider_callout_html' ) );
	 ...
	 * Map element
	 */
	function kc_slider_callout_mapping() {

		if ( function_exists( 'kc_add_map' ) ) {
			kc_add_map(
				array(

					'kc_slider_callout' => array(
						'name'        => __( 'Slider Left Content Callout', 'msteele' ),
	 ...
	 * @return string
	 */
	function kc_slider_callout_html( $atts ) {
		// params extraction
		extract(
			shortcode_atts(
				array(
					...
					<?php foreach ( $images as $image ): ?>
                            <div class="swiper-slide">
								<div class="slider-x-element">
									<img src="/wp-content/uploads/2022/01/large-X.svg" alt="">
								</div>
