...
// Element Class
class SliderRightContentCallout {
	// element Init
	function __construct() {
		add_action( 'init', array( $this, 'kc_Right_slider_callout_mapping' ), 99 );
		add_shortcode( 'kc_Right_slider_callout', array( $this, 'kc_Right_slider_callout_html' ) );
	 ...
	 * Map element
	 */
	function kc_Right_slider_callout_mapping() {

		if ( function_exists( 'kc_add_map' ) ) {
			kc_add_map(
				array(

					'kc_Right_slider_callout' => array(
						'name'        => __( 'Slider Right Content Callout', 'msteele' ),
	 ...
	 * @return string
	 */
	function kc_Right_slider_callout_html( $atts ) {
		// params extraction
		extract(
			shortcode_atts(
				array(
					...
					<?php foreach ( $images as $image ): ?>
                            <div class="swiper-slide">
								<div class="row">
									...
									<div class="col-xl-6 pl-xl-0  bg-white">
										<?php if ( $image['description'] ) : ?>
											<div class="swipper-content">
												<div class="description">
													<?php echo $image['description']; ?>
												</div>
												<div class="d-md-flex align-items-center slider-actions py-1 py-lg-5">
													<div class="slider-btn mr-5">
														<a class="btn-border" href="/building/">Building</a>
													</div>
