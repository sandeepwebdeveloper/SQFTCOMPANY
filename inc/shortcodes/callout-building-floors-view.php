...
/**
 * Class FloorLevelsCallout
 */
class FloorLevelsCallout {
    /**
     * FloorLevelsCallout constructor.
     */
    function __construct() {
        add_action( 'init', array( $this, 'kc_floorsviews_callout_mapping' ), 99 );
        add_shortcode( 'kc_floorsviews_callout', array( $this, 'kc_floorsviews_callout_html' ) );
     ...
     * @since 1.0.0
     */
    function kc_floorsviews_callout_mapping() {

        if ( function_exists( 'kc_add_map' ) ) {
            kc_add_map(
                array(

                    'kc_floorsviews_callout' => array(
                        'name'        => __( 'Floor Views Callout', 'msteele' ),
                        'description' => __( 'Display Floor Views', 'msteele' ),
                        'icon'        => '',
                        'category'    => 'Content',
                        'params'      => array(
                            'General'       => array(
     ...
     * @since 1.0.0
     */
    function kc_floorsviews_callout_html( $atts ) {
        // params extraction
        extract(
            shortcode_atts(
                array(
                            ...
                            <div class="col-md-9 d-none d-xl-block">
                                <div class="floors-image-block">
                                    ...
                                    <div id="img<?php echo $stripped_text; ?>" class="floor-image pageAttr">
                                        <?php  $floorImg = get_field('field_ms_toolkit_floor_view_preview'); ?>
                                    ...
                                    <div class="accordion-item">
                                        ...
                                        ?>
                                            <button id="#img<?php echo $stripped_text; ?>" class="accordion-button cards__title <?php echo $collasped;  ?>" type="button" data-bs-toggle="collapse" data-bs-target="#collapse-<?php echo $features_M; ?>" aria-expanded="true" aria-controls="collapse-<?php echo $features_M; ?>">
                                                <?php  $floorImg = get_field('field_ms_toolkit_floor_view_preview'); ?>
                                                <img class="d-xl-none" src="<?php echo $floorImg['url']; ?>" alt="<?php the_title(); ?>">
                                                <div class="floor-title">
                                                    <?php the_title(); ?> <span>floor<br/>amenities</span>
                                                </div>
                                            </button>
                                        </h2>
                                        <div id="collapse-<?php echo $features_M; ?>" class="accordion-collapse <?php echo $show_class;  ?>" aria-labelledby="heading-<?php echo $features_M; ?>" data-bs-parent="#accordionExample">
                                            <div class="accordion-body">
                                                <?php  echo $floorListing = get_field('field_ms_toolkit_floor_view_description'); ?>
                                            </div>
                                        </div>
                                    </div>
                                <?php endwhile; ?>
