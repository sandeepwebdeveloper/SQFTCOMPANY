...
class TextCallout {
	...
	function __construct() {
		add_action( 'init', array( $this, 'kc_text_callout_mapping' ), 99 );
		add_shortcode( 'kc_text_callout', array( $this, 'kc_text_callout_html' ) );
	 ...
	 * @since 1.0.0
	 */
	function kc_text_callout_mapping() {

		if ( function_exists( 'kc_add_map' ) ) {
			kc_add_map(
				array(

					'kc_text_callout' => array(
						'name'        => __( 'Raw Text Call Out', 'msteele' ),
						'description' => __( 'Display raw text', 'msteele' ),
						'icon'        => '',
						'category'    => 'Content',
						'params'      => array(
							'General'       => array(
	 ...
	 * @since 1.0.0
	 */
	function kc_text_callout_html( $atts ) {
		// params extraction
		extract(
			shortcode_atts(
				array(
		...
		// start the output
		ob_start(); ?>
        <div class="text-callout <?php echo $atts['class']; ?>">
            <div class="text-content" <?php echo $animation; ?>>
