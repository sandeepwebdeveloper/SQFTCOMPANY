    ...
    Panzoom.prototype = {
        ...
        resetDimensions: function() {
            ...
            var dims = this.dimensions = this.isSVG ? {
                ...
                marginLeft: $.css( elem, 'marginLeft', true ) || 0,
                marginTop: $.css( elem, 'marginTop', true ) || 0
            };
        ...
        setMatrix: function( matrix, options ) {
            ...
            if ( contain ) {
                ...
                if ( contain === 'invert' ) {
                    ...
                    matrix[4] = Math.max( Math.min( matrix[4], marginW - dims.left - dims.marginLeft ), -marginW - dims.left - dims.marginLeft - diffW );
                    matrix[5] = Math.max( Math.min( matrix[5], marginH - dims.top - dims.marginTop ), -marginH - dims.top - dims.marginTop - diffH + dims.heightBorder );
                } else {
