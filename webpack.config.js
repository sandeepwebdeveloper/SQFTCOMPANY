...
let config = {
    entry: {
        scripts: ["babel-polyfill", "./scripts/app-scripts.js"]
    },
    plugins: [],
    module: {
        rules: [
...
if (currentTask == "devFast") {
    ...
    config.output = {
        ...
        publicPath: "http://localhost:3736/"
    }
    config.devServer = {
        ...
        public: "http://localhost:3736",
        publicPath: "http://localhost:3736/",
        disableHostCheck: true,
        contentBase: path.join(__dirname),
        contentBasePublicPath: "http://localhost:3736/",
        hot: true,
        port: 3736,
        headers: {
...
if (currentTask == "build" || currentTask == "buildWatch") {
    ...
    config.output = {
        publicPath: "/wp-content/themes/westlinecondos/bundled-assets/",
